...
# Calculate speed limits for fans in both CPU and Disk Device fan zones.
#
# Set RPM limit vars $cpu_fan_speed_limit and $device_fan_speed_limit.
##

collect_max_fan_speed
...
debug_print 3 "Peripheral (non-CPU) pre-validation fan duty minimum duty cycle: ${device_fan_duty_min}%"
...
--> 4. sanity checks on values before and after real world tests
